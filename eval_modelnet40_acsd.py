...
def evaluate(args):
    ...
    d = modelnet.DataConsumer(file='data/modelnet40_ply_hdf5_2048/test_files.txt', batch_size=batch_size,
                              num_points=num_points, num_channels=num_channels, test=True,
